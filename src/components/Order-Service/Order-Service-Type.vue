      ...
      <div class="form-row">
        <div class="col-md-4 mb-1 mt-5 ml-3 mr-3">
          <fieldset>
            ...
            <p class="mt-3" v-else>
              <input type="radio" id="otherType" value="outro tipo" v-model="orderServiceType" />
