          ...
          <div class="step1">
            <div class="form-row">
              <div class="col-md-4 mb-1 mt-5 ml-3 mr-3">
                ...
                <p class="mt-3" v-if="!otherType"><button @click="otherType = !otherType" type="button" class="btn btn-rounded btn-md btn-outline-simple btn-block">Outro tipo</button></p>
                <p class="type pt-2 pb-2" v-if="otherType">
